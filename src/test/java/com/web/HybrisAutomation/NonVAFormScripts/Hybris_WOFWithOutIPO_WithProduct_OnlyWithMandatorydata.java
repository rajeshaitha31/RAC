...
public class Hybris_WOFWithOutIPO_WithProduct_OnlyWithMandatorydata extends TestEngineWeb {
	...
	public void Hybris_WOFWithOutIPO_WithProduct_OnlyWithMandatorydata_Test() throws Throwable
	{
     boolean flag = false;	
