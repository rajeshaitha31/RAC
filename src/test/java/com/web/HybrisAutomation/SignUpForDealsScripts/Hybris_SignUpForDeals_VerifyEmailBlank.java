...
public class Hybris_SignUpForDeals_VerifyEmailBlank extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
		      ...
		      this.Email = ExcelReader.fn_GetCellData(sheetPath, sheetName, 5,"Email"); 
			  this.VerifyEmail = ExcelReader.fn_GetCellData(sheetPath, sheetName,5, "VerifyEmail");
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 5, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 5, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 5, "ZipCode");
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_VerifyEmailBlank_Test() throws Throwable{
