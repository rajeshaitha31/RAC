...
public class Hybris_SignUpForDeals_SetStore_DifferentVerifyEmail extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
		      ...
		      this.Email = ExcelReader.fn_GetCellData(sheetPath, sheetName, 9,"Email"); 
			  this.VerifyEmail = ExcelReader.fn_GetCellData(sheetPath, sheetName,9, "VerifyEmail");
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 9, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 9, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 9, "ZipCode");
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_SetStore_DifferentVerifyEmail_Test() throws Throwable{
