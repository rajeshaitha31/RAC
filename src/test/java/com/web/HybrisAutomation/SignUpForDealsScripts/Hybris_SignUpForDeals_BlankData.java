...
public class Hybris_SignUpForDeals_BlankData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
			  ...
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 3, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 3, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 3, "ZipCode");
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_BlankData_Test() throws Throwable{
