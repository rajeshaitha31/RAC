...
public class Hybris_SignUpForDeals_ValidData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
			  ...
			  this.VerifyEmail = ExcelReader.fn_GetCellData(sheetPath, sheetName,1, "VerifyEmail");
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 1, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 1, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 1, "ZipCode");
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_ValidData_Test() throws Throwable{
