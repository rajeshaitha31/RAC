...
public class Hybris_SignUpForDeals_SetStore_BlankData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
			  ...
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 8, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 8, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 8, "ZipCode");
			 
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_SetStore_BlankData_Test() throws Throwable{
		...
		flag=hybris_signupdealspage.FillBlankData_SignUpForDeals(FirstName, LastName, ZipCode);
		Assert.assertEquals(true, flag, "FillDataintheForm");
		flag=hybris_signupdealspage.VerifyBlankEmailValidation();
	}
