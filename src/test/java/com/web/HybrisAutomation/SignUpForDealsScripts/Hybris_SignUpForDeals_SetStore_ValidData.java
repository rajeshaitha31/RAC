...
public class Hybris_SignUpForDeals_SetStore_ValidData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
		      ...
		      this.Email = ExcelReader.fn_GetCellData(sheetPath, sheetName, 6,"Email"); 
			  this.VerifyEmail = ExcelReader.fn_GetCellData(sheetPath, sheetName,6, "VerifyEmail");
			  this.FirstName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 6, "FirstName");
			  this.LastName = ExcelReader.fn_GetCellData(sheetPath, sheetName, 6, "LastName");
			  this.ZipCode = ExcelReader.fn_GetCellData(sheetPath, sheetName, 6, "ZipCode");
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_SignUpForDeals_SetStore_ValidData_Test() throws Throwable{
