...
public class Hybris_UnsubscribeForDeals_SetStore_InvalidData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException,FilloException {
		//Login Details
		      ...
		      this.email = ExcelReader.fn_GetCellData(sheetPath, sheetName, 3,"Email"); 
			  
	} 
	
	@Test(groups = { "smoke", "regression" })
	public void Hybris_UnsubscribeForDeals_SetStore_InvalidData_Test() throws Throwable{
		...
		flag=hybris_unsubscribe.unsubscribe_VerifyErrorMessage();
		Assert.assertEquals(true, flag, "VerifyErrorMessage");
