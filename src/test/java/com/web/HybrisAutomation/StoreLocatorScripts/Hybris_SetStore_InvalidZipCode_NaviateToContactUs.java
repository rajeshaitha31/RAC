...
public class Hybris_SetStore_InvalidZipCode_NaviateToContactUs extends TestEngineWeb {
	...
	public void Hybris_SetStore_InvalidZipCode_NaviateToContactUs_Test() throws Throwable
	{
     boolean flag = false;	
     ...
     Assert.assertEquals(true, flag, "LaunchApplication");
		actionLib.WebdriverWaitForPage();
        	...
        	actionLib.javascriptClick(CommonVariables.CommonDriver.get().findElement(HomePage_OR.STORELOCATOR_CONTACTUS));
        	extentLogs.pass("ClickContactUs","ClickedContactUs");
        	CommonVariables.CommonDriver.get().findElement(ContactUs_OR.ContactUs_PageTitle).isDisplayed();
    		extentLogs.pass("ContactUsPage","NavigatedToContactUsPage");
