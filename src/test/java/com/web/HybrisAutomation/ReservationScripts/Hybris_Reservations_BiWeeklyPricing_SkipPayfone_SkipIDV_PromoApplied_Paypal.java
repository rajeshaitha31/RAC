...
public class Hybris_Reservations_BiWeeklyPricing_SkipPayfone_SkipIDV_PromoApplied_Paypal extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException {
		...
		this.BaseStore = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "BaseStore");
		this.Productcode = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "Productcode");
		this.FirstName = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "FirstName");
		this.LastName = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "LastName");
		this.PhoneNumber = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "PhoneNumber");
		this.Email = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "Email");
		this.VerifyEmail = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "VerifyEmail");
		this.StreetAddress = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "StreetAddress");
		this.Apartment = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "Apartment");
		this.City = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "City");
		this.State = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "State");
		this.ZipCode = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "ZipCode");
		//System.out.println("Card Value before"+ CardNumber);
		this.CardNumber=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "CardNumber");
		...
		this.CardMonth=Integer.parseInt(ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "CardMonth"));
		this.CardYear=Integer.parseInt(ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "CardYear"));
		this.CVV=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "CVV");
		this.PaypalEmailid=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "PaypalEmailid");
		this.PaypalPassword=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 4, "PaypalPassword");
		// Employment Details
	...
	public void Hybris_Reservations_BiWeeklyPricing_PromoApplied_SkipPayfone_SkipIDV_PaypalTest() throws Throwable {
		boolean flag = false;
		...
		flag = hybrispdppage.PDP_SetBiWeeklyPricingOption();
		actionLib.WebdriverWaitForPage();
