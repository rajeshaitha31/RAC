...
public class Hybris_Reservations_MonthlyPricing_Paypal extends TestEngineWeb {
	...
	public void Hybris_Reservations_MonthlyPricing_NoPromo_PaypalTest() throws Throwable {
		boolean flag = false;
