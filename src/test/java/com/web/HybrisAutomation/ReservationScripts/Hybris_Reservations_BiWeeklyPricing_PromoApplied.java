...
public class Hybris_Reservations_BiWeeklyPricing_PromoApplied extends TestEngineWeb {
	...
	public void Hybris_Reservations_BiWeeklyPricing_PromoApplied_Test() throws Throwable {
		boolean flag = false;
		...
		actionLib.javascriptClick(CommonVariables.CommonDriver.get().findElement(ClaimIPO_OR.IPO_SUBMIT));
