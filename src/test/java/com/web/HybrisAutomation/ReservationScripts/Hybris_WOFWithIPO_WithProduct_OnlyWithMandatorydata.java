...
public class Hybris_WOFWithIPO_WithProduct_OnlyWithMandatorydata extends TestEngineWeb {
	...
	public void Hybris_WOFWithIPO_WithProduct_OnlyWithMandatorydata_Test() throws Throwable
	{
     boolean flag = false;	
