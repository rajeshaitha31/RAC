...
public class Hybris_NonVA_SubmitContactInfo_WithProduct extends TestEngineWeb {
	...
	public void Hybris_NonVA_SubmitContactInfo_WithProduct_Test() throws Throwable
	{
     boolean flag = false;	
