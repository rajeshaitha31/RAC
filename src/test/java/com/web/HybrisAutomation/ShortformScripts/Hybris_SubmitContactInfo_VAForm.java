...
public class Hybris_SubmitContactInfo_VAForm extends TestEngineWeb {

	ActionsLibrary actionLib = new ActionsLibrary();
	private HybrisHomePage hybris_homepage;
    private HybrisGetApprovedNowPage getApproved;
    
	private HybrisVAConfirmationPage vaconfirmationpage;
	...
	protected String sheetName = "VA_Approved";
	...
	public void Hybris_SubmitContactInfo_VAForm_Test() throws Throwable
	{
     boolean flag = false;	
    ...
    flag = getApproved.GetApproved_SubmitContactInformation();
    actionLib.WebdriverWaitForPage();
    flag = getApproved.GetApproved_ClickOnJustContactMe();
    actionLib.WebdriverWaitForPage();
    
    vaconfirmationpage = new HybrisVAConfirmationPage(CommonVariables.CommonDriver.get());
    flag =  vaconfirmationpage.VA_OrderConfirmation_ThankYouMessage();
    flag =  vaconfirmationpage.VA_OrderConfirmation_ProductDetails();
    flag =  vaconfirmationpage.VA_OrderConfirmation_WhatIsNextSection();
    flag =  vaconfirmationpage.VA_OrderConfirmation_UponDeliverySection();
    flag =  vaconfirmationpage.VA_OrderConfirmation_MyStoreSection();
