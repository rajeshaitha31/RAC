...
public class Hybris_Reservations_MonthlyPricing_SkipPayfone_SkipIDV_Paypal extends TestEngineWeb {
	...
	private String Productcode, BaseStore, FirstName, LastName, PhoneNumber, Email, VerifyEmail, StreetAddress,
			Apartment, City, State, ZipCode, CVV,SSN,ApplyPromo;
	...
	public void beforeMethod() throws IOException {
		...
		this.ApplyPromo=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 3, "ApplyPromo");
		// Employment Details
	...
	public void Hybris_Reservations_MonthlyPricing_SkipPayfone_SkipIDV_NoPromo_PaypalTest() throws Throwable {
		boolean flag = false;
