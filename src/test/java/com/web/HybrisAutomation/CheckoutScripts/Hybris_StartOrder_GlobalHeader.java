...
public class Hybris_StartOrder_GlobalHeader extends TestEngineWeb {
	...
	public void Hybris_StartOrder_GlobalHeader_Test() throws Throwable{
	    ...
	    Assert.assertEquals(true, flag, "StartOrder_Homepage_GlobalHeader");
