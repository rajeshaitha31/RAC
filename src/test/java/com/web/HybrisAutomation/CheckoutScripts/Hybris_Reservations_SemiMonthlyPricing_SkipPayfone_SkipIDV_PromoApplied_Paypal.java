...
public class Hybris_Reservations_SemiMonthlyPricing_SkipPayfone_SkipIDV_PromoApplied_Paypal extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException {
		...
		this.CardNumber=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "CardNumber");
		...
		this.CardMonth=Integer.parseInt(ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "CardMonth"));
		this.CardYear=Integer.parseInt(ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "CardYear"));
		this.CVV=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "CVV");
		this.PaypalEmailid=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "PaypalEmailid");
		this.PaypalPassword=ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, 2, "PaypalPassword");
		// Employment Details
	...
	public void Hybris_Reservations_SemiMonthlyPricing_PromoApplied_SkipPayfone_SkipIDV_PaypalTest() throws Throwable {
		boolean flag = false;
