...
public class Hybris_MyAccount_NavigateToPaymentHistoryFromPaymentMethods extends TestEngineWeb {
...
public void Hybris_MyAccount_NavigateToPaymentHistoryFromPaymentMethods_Test() throws Throwable{
...
actionLib.WebdriverWaitForPage();
  ...
  actionLib.WebdriverWaitForPage();
  actionLib.Click(CommonVariables.CommonDriver.get().findElement(MyAccount_OR.PAYMENTMETHODS_PAYMENTHITORYQUICKLINK));
  
  if(CommonVariables.CommonDriver.get().findElement(MyAccount_OR.PAYMENTHISTORY_LABEL).isDisplayed()){
	  extentLogs.pass("PaymentHistory", "PaymentHitoryPageDisplayed");
  }
  else {
	  extentLogs.fail("PaymentHistory", "PaymentHitoryPageIsNotDisplayed");
  }
