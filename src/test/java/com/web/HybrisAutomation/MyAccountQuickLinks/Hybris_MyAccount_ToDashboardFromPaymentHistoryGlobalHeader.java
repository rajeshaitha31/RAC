...
public class Hybris_MyAccount_ToDashboardFromPaymentHistoryGlobalHeader extends TestEngineWeb {
...
public void Hybris_MyAccount_ToDashboardFromPaymentHistoryGlobalHeader_Test() throws Throwable{
...
actionLib.WebdriverWaitForPage();
  ...
  actionLib.WebdriverWaitForPage();
  flag=hybris_myaccount.GlobalHeader_DashBoard(); 
  Assert.assertEquals(true, flag,"Navigated to My DashBoard Page"); 
  actionLib.WebdriverWaitForPage();
