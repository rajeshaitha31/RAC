...
public class Hybris_MyAccount_NavigateToPersonalInfoFromPaymentHistory extends TestEngineWeb {
...
public void Hybris_MyAccount_NavigateToPersonalInfoFromPaymentHistory_Test() throws Throwable{
...
actionLib.WebdriverWaitForPage();
  ...
  actionLib.WebdriverWaitForPage();
  actionLib.Click(CommonVariables.CommonDriver.get().findElement(MyAccount_OR.PAYMENTHISTORY_PERSONALINFOQUICKLINK));
