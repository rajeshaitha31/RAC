...
public class Hybris_TopCategories_Appliances extends TestEngineWeb {
	
	ActionsLibrary actionLib = new ActionsLibrary();
	private HybrisHomePage hybris_homepage;
	private HybrisTopCategoriesPage hybris_topcategoriespage;
	private ExtentLogs extentLogs = new ExtentLogs();
	private String Category = "Appliances";

		
	@Test(groups = { "smoke", "regression" })
	public void Hybris_TopCategories_Appliances_Test() throws Throwable{
