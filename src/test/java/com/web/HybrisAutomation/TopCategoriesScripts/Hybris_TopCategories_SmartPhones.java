...
public class Hybris_TopCategories_SmartPhones extends TestEngineWeb {
	...
	public void Hybris_TopCategories_Smartphones_Test() throws Throwable{
		...
		hybris_topcategoriespage.VerifySmartPhonesPage();
