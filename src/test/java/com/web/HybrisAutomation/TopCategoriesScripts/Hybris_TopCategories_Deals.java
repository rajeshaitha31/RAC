...
public class Hybris_TopCategories_Deals extends TestEngineWeb {
	
	ActionsLibrary actionLib = new ActionsLibrary();
	private HybrisHomePage hybris_homepage;
	private HybrisTopCategoriesPage hybris_topcategoriespage;
	private ExtentLogs extentLogs = new ExtentLogs();
	private String Category = "Deals";

		
	@Test(groups = { "smoke", "regression" })
	public void Hybris_TopCategories_AllDeals_Test() throws Throwable{
		...
		hybris_topcategoriespage.NavigateToTopCategory(Category);
		hybris_topcategoriespage.VerifyDealsPage();
