...
public class Hybris_VirtualApproval_Conditional extends TestEngineWeb {
	...
	protected String sheetName = "VA_Conditional";
	...
	public void Hybris_VirtualApproval_Conditional_Test() throws Throwable
	{
     boolean flag = false;	
    ...
    flag=vaconfirmpage.VerifyData_VAConditionalMessage();
