...
public class Hybris_MyAccount_EditPersonalInfo_AddressDetails extends TestEngineWeb {
...
public void Hybris_MyAccount_EditPersonalInfo_AddressDetails_Test() throws Throwable{
...
actionLib.WebdriverWaitForPage();
  ...
  flag=hybris_myaccount.editPersonalInfo_AddressDetails();
  Assert.assertEquals(true, flag, "UpdatedAddressDetails");
  actionLib.WebdriverWaitForPage();
