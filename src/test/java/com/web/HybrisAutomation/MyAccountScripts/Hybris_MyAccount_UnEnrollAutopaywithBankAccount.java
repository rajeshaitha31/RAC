...
public class Hybris_MyAccount_UnEnrollAutopaywithBankAccount extends TestEngineWeb {
...
public void Hybris_MyAccount_UnEnrollAutopaywithBankAccount_Test() throws Throwable{
...
actionLib.WebdriverWaitForPage();
  ...
  flag=hybris_myaccount.UnEnrollAutopay();
  Assert.assertEquals(true, flag, "UnEnrolled For Autopay");
