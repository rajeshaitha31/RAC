...
public class Hybris_VerifyBrokenLinks_ContactUs extends TestEngineWeb {
	...
	public void Hybris_VerifyBrokenLinks_ContactUs_Test() throws Throwable{
				
		hybris_homepage = new HybrisHomePage(CommonVariables.CommonDriver.get());
		final String Url=ConfigManager.getProperties().getProperty("ContactUs");	
