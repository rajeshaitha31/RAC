...
public class Hybris_VerifyBrokenLinks_FAQ extends TestEngineWeb {
	...
	public void Hybris_VerifyBrokenLinks_FAQ_Test() throws Throwable{
				
		hybris_homepage = new HybrisHomePage(CommonVariables.CommonDriver.get());
		final String Url=ConfigManager.getProperties().getProperty("FAQ");	
