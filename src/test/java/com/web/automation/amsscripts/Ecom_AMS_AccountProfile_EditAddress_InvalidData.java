...
public class Ecom_AMS_AccountProfile_EditAddress_InvalidData extends TestEngineWeb {
  ...
  public void Ecom_AMS_AccountProfile_EditAddress_InvalidData() throws Throwable {
	  ...
	  ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		...
		ecom_homepage.VA_VerifyErrorMsg_Invaliddata(EcomAMS_OR.ADDRESS_ERRORMSG,
				"Please enter a valid address. The allowed special characters are: / , - ( ) # & : ; .@Please enter a valid apartment number. The allowed special characters are: / , - ( ) # & : ; .@Please enter a valid city. The allowed special characters are: / , - ( ) # & : ; .@Please enter your 5 digit ZIP code.");
