...
public class Ecom_AMS_AccountProfile_EditPersonalInfo_ContactDetails_ValidData extends TestEngineWeb {
  ...
  public void Ecom_AMS_AccountProfile_EditPersonalInfo_ContactDetails_ValidData() throws Throwable {
	  ...
	  ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		...
		if(actionLib.isElementPresent(EcomAMS_OR.EDITCONTACTDETAILS_SUCCESSMSG)) {
		extentLogs.pass("VerifySuccessMessage", "Contact information has been updated.");}
		amspage.logout();
