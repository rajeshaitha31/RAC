...
public class Ecom_AMS_AddCreditCardPaymentMehod_BlankData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException, FilloException {
		...
		testdata = ExcelReader.GetData(sheetPath,
				"Select * from TestData where TestCaseName='Ecom_AMS_AddPaymentMehod_CreditCard_BlankData'");
	}
	
	@Test(alwaysRun = true, groups = { "smoke", "regression" })
  public void Ecom_AMS_AddCreditCardPaymentMehod_BlankData() throws Throwable {
