...
public class Ecom_AMS_AccountProfile_EditPersonalInfo_ContactDetails_BlankData extends TestEngineWeb {
  ...
  public void Ecom_AMS_AccountProfile_EditPersonalInfo_ContactDetails_BlankData() throws Throwable {
	  ...
	  ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		...
		amspage.editPersonalInfo_contactDetails(testdata,0);
		ecom_homepage.verifyErrorMsg(EcomAMS_OR.ACH_ERRORMSGVALIDATION,
				"Please enter phone number.;Please select an option.");
