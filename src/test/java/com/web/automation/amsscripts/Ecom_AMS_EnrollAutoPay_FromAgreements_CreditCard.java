...
public class Ecom_AMS_EnrollAutoPay_FromAgreements_CreditCard extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException, FilloException {
		...
		testdata = ExcelReader.GetData(sheetPath,
				"Select * from TestData where TestCaseName='Ecom_AMS_EnrollAutoPay_FromAgreements_CreditCard'");
	}
	
	@Test(alwaysRun = true, groups = { "smoke", "regression" })
  public void Ecom_AMS_EnrollAutoPay_FromAgreements_CreditCard() throws Throwable {
