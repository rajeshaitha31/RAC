...
public class Ecom_AMS_DeletePaymentMehod_Credicard extends TestEngineWeb {
  ...
  public void Ecom_AMS_DeletePaymentMehod_Credicard() throws Throwable {
	  ...
	  ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		...
		amspage.deletePaymentMethod(testdata);
		amspage.logout();
