...
public class Ecom_SetStore_ValidZipCode extends TestEngineWeb {
	...
	public void Ecom_SetStore_ValidZip() throws Throwable{
        ...
        try{
        	...
        	actionLib.type(CommonVariables.CommonDriver.get().findElement(Ecom.EnterZip), "71111");
