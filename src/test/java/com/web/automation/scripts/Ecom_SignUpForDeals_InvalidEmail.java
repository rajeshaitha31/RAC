...
public class Ecom_SignUpForDeals_InvalidEmail extends TestEngineWeb {
	...
	public void SignUpForDeals_InvalidEmail() throws Throwable {
		ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		ecom_homepage.LaunchApplication();
		actionLib.WebdriverWaitForPage();

		while (testdata.next()) {
			ecom_homepage.signUpForDeals_InvalidEmail(testdata);
