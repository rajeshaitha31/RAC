...
public class Ecom_VA_ScreenValidations_ApprovalInfo_DuplicateData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException, FilloException {
		...
		testdata = ExcelReader.GetData(sheetPath,
				"Select * from TestData where TestCaseName='Ecom_VAScreenValidation_ApprovalInfo_Duplicatedata'");
	}

	@Test(alwaysRun = true, groups = { "smoke", "regression" })
	public void Ecom_VA_ScreenValidations_ApprovalInfo_DuplicateData_Test() throws Throwable {
		...
		while (testdata.next()) {
			...
			ecom_homepage.VA_VerifyErrorMsg(Ecom.VA_ApprovalInfo_UniqueNameMessage,
					"Please provide a different contact.;Please provide a different contact.;Please provide a different contact.");

			ecom_homepage.VA_VerifyErrorMsg(Ecom.VA_ApprovalInfo_UniquePhoneMessage, 
					"Please enter a unique phone number.;Please enter a unique phone number.;Please enter a unique phone number.");
