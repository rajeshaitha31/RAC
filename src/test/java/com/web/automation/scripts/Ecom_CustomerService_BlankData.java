...
public class Ecom_CustomerService_BlankData extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException, FilloException {
		...
		testdata = ExcelReader.GetData(sheetPath,
				"Select * from CustomerService where TestCaseName='CustomerService_BlankData'");

	}

	@Test(groups = { "smoke", "regression" })
	public void Ecom_CustomerService_BlankData() throws Throwable {
