...
public class Ecom_Unsubscribe_UnsubscribeDeals extends TestEngineWeb {
	...
	public void Unsubscribe_UnsubscribeDeals() throws Throwable {
		ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
		ecom_homepage.LaunchApplication();
		actionLib.WebdriverWaitForPage();

		while (testdata.next()) {
			ecom_homepage.unsubscribeForDeals_Unsubscribe(testdata);
