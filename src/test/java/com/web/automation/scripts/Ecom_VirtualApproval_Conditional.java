...
public class Ecom_VirtualApproval_Conditional extends TestEngineWeb {
	...
	protected String sheetName = "VAFlow_Conditional";
	...
	public void Ecom_VirtualApproval_Conditional() throws Throwable{
	    	...
	    	ecom_homepage.Navigate_To_Pdp_withproductcode(productcode);
	        	...
	        	extentLogs.info("VAFlow", "ClickonVAFlowButton");
	    	    	    ...
	    	    	    ecom_homepage.VA_FillData_VAForm(FirstName, LastName, BaseStore, PhoneType,PhoneNumber,
	    	   		     ...
	    	   		     ecom_homepage.VerifyData_VAConditionalPage();
