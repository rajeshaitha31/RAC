...
public class Ecom_GA_SetStore_InvalidZip extends TestEngineWeb{
	...
	public void Ecom_GA_SetStore_InvalidStoreZip() throws Throwable{
        ...
        actionLib.type(CommonVariables.CommonDriver.get().findElement(Ecom.GA_EnterZip), "abcde" );
        ...
        actionLib.isElementPresent(Ecom.GA_store_errormessage_invalidzip);
        extentLogs.pass("VerifyErrorMessage", "InvalidStoreErrorMessageDisplayed");
