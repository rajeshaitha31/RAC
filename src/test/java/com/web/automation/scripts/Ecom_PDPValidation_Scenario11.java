...
//TC11-Franchise Store - NONVA InvN EcomN WebonlyY
...
public class Ecom_PDPValidation_Scenario11 extends TestEngineWeb {
	...
	private String productcode = "100023109";
	//private String productcode = "100024655";
	
	@Test(groups = { "smoke", "regression" })
	public void PDPValidation_Scenario11_Test() throws Throwable{
    ...
    extentLogs.info("PDPValidation", "Franchise Store - NONVA InvN EcomN WebonlyY");
