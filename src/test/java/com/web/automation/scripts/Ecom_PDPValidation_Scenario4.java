...
//RTO Store - VANONVA InvY EcomN WebonlyN
...
public class Ecom_PDPValidation_Scenario4 extends TestEngineWeb{
	
	ActionsLibrary actionLib = new ActionsLibrary();
	private Ecom_HomePage ecom_homepage;
	private ExtentLogs extentLogs = new ExtentLogs();
	
	private String basestore = "37407";
	private String productcode = "100017675";
	
	@Test(groups = { "smoke", "regression" })
	public void PDPValidation_Scenario4_Test() throws Throwable{
	    ...
	    extentLogs.info("PDPValidations", "RTO Store VANONVA InvY EcomN WebonlyN");
