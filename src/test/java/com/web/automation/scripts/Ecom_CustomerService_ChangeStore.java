...
public class Ecom_CustomerService_ChangeStore extends TestEngineWeb {
	...
	public void beforeMethod() throws IOException, FilloException {
		...
		testdata = ExcelReader.GetData(sheetPath,
				"Select * from CustomerService where TestCaseName='CustomerService_ChangeStore'");

	}

	@Test(groups = { "smoke", "regression" })
	public void Ecom_CustomerService_ChangeStore() throws Throwable {
		...
		while (testdata.next()) {
			...
			ecom_homepage.customerService_ChangeStore(testdata);
			Assert.assertEquals(
