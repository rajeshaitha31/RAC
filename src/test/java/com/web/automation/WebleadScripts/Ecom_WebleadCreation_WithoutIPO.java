...
public class Ecom_WebleadCreation_WithoutIPO extends TestEngineWeb {
	...
	private String Productcode,PhoneNumber,PhoneType,Email,VerifyEmail,StreetAddress,Apartment,City,State,ZipCode;
	...
	protected String sheetPath = System.getProperty("user.dir").replace("\\", "/") + "/testdata/WebleadTestDataWithoutOffer.xlsx";
	protected String sheetName = "TestData";
    Map<String, List<String>> testdata = null;
    
    
	@Test(alwaysRun = true, groups = { "smoke", "regression" })
	public void Ecom_WebLead_WithoutIPO() throws Throwable{
		 ...
		 for(int i=1;i<=rowcount;i++) {
			...
			this.RefPhone2 = ExcelReader.fn_GetCellData(this.sheetPath, this.sheetName, i, "RefPhone2");
			 ...
			 ecom_homepage = new Ecom_HomePage(CommonVariables.CommonDriver.get());
			    ...
			    actionLib.WebdriverWaitForPage();
			    ecom_homepage.NonVA_FillData_Weblead_WithoutIPO( PhoneType, PhoneNumber, Email, VerifyEmail,
