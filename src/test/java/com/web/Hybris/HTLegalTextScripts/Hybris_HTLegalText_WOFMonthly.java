...
public class Hybris_HTLegalText_WOFMonthly extends TestEngineWeb {
	ActionsLibrary actionLib = new ActionsLibrary();
	private HybrisHomePage hybris_homepage;
	private HybrisPDPPage hybrispdppage;
	private HybrisStartYourOrderPage hybrisStOpage;
	...
	public void Hybris_HTLegalText_WOFMonthly_Test() throws Throwable
	{
     boolean flag = false;	
	...
	flag = hybrispdppage.Monthly_PDP_StartYourOrder();

				
	hybrisStOpage  = new HybrisStartYourOrderPage(CommonVariables.CommonDriver.get());
	actionLib.WebdriverWaitForPage();
	flag=hybrisStOpage.StartYourOrder_ExpandPricing();
	flag = hybrisStOpage.WOF_ValidateHTLegalText();
